...
\begin{figure}[H]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{../gan/data_gan/interpolations_30000.png}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{../gan/data_ls_gan/interpolations_30000.png}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{../gan/data_wgan_gp/interpolations_30000.png}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{../vae/data/ae_latent16/epoch_19_recons.png}
    \caption{Reconstructions: (size 16)}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{../vae/data/ae_latent128/epoch_19_recons.png}
        \caption{Reconstructions: (size 128)}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{../vae/data/ae_latent1024/epoch_19_recons.png}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{../vae/data/vae_latent_beta_.8/epoch_19_recons.png}
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{../vae/data/vae_latent_beta_annealing/epoch_19_recons.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{../diffusion/data_ddpm/samples_ddpm.png}
        \caption{DDPM Samples}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{../diffusion/data_ddim/samples_ddim.png}
